...
export class FacturacionService {
  ...
  descargarComprobante(id: number): Observable<Blob> {
    return this.http.get(`${this.base}/api/facturas/${id}/comprobante`, {
      responseType: 'blob',
    });
  }
  ...
  emisor(): Observable<Emisor> {
    return this.http.get<Emisor>(`${this.base}/api/emisor`);
  }
